      ...
      <main className="relative z-10 flex-grow mx-auto max-w-7xl w-full px-6 pb-24">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {careerPaths.map((path, idx) => (
            <div key={idx} className="group relative p-8 rounded-[2.5rem] bg-zinc-900 border border-white/5 hover:border-white/10 transition-all flex flex-col">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <Link href="/careers/role" className="p-8 rounded-3xl bg-zinc-900/50 border border-white/5 hover:border-emerald-500/20 transition-all group">
          ...
          <Link href="/careers/benefits" className="p-8 rounded-3xl bg-zinc-900/50 border border-white/5 hover:border-emerald-500/20 transition-all group">
            <div className="flex justify-between items-start mb-4">
