...
export default function FitQuiz() {
  ...
  // Calculate percentage based on answers provided
      ...
      <div className="flex-grow flex flex-col">
        {!isFinished ? (
          ...
          <main className="flex-grow flex flex-col items-center justify-center p-6 text-center animate-in zoom-in-95 duration-700 pt-32 pb-20">
            ...
            <Link href="/signup" className="h-16 px-12 rounded-2xl bg-white text-black font-black uppercase tracking-widest hover:bg-emerald-400 transition-all flex items-center justify-center hover:scale-105 shadow-xl text-[11px]">
