...
export default function EligibilityPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white font-sans selection:bg-emerald-500/30">
      ...
      {/* HEADER SECTION - Matched to Careers/Branches Page styling */}
      ...
      <main className="relative z-20 mx-auto max-w-7xl px-6 pb-24">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-20">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="p-8 md:p-10 rounded-[2.5rem] bg-zinc-900/50 border border-white/5 backdrop-blur-md">
          ...
          <div className="lg:col-span-1">
            <div className="h-full p-10 rounded-[2.5rem] bg-zinc-900 border border-white/5 flex flex-col justify-center text-center">
