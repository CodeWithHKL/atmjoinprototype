  ...
  return (
    <div className="relative min-h-screen bg-zinc-950 text-white font-sans selection:bg-emerald-500/30 flex flex-col">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="relative z-20 mx-auto max-w-7xl px-6 pb-24 flex-grow w-full">
          {/* 1. GENERAL REQUIREMENTS */}
          <div className="mb-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {generalCriteria.map((item, idx) => (
              <div key={idx} className="flex items-center gap-3 p-5 rounded-2xl bg-black/40 border border-white/10 backdrop-blur-xl">
          ...
          <div className="flex justify-center mb-16">
            <div className="inline-flex p-1.5 bg-black/60 rounded-3xl border border-white/10 shadow-2xl backdrop-blur-2xl">
              <button
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-20">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="p-8 md:p-10 rounded-[2.5rem] bg-black/40 border border-white/10 backdrop-blur-xl">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left">
                    <thead>
                      <tr className="text-[9px] font-black uppercase text-zinc-600 border-b border-white/10">
              ...
              {/* Note Section */}
              <div className="p-6 rounded-3xl bg-blue-500/5 border border-blue-500/20 backdrop-blur-md flex items-center gap-4">
            ...
            <div className="lg:col-span-1">
              <div className="h-full p-10 rounded-[2.5rem] bg-black/40 backdrop-blur-xl border border-white/10 flex flex-col justify-center text-center hover:border-emerald-500/30 transition-all">
                ...
                >
                  Start Matcher <ChevronRight size={14} className="group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
            </div>
          </div>
