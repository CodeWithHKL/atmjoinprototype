...
export default function LoggedInFAQPage() {
    ...
    <div className="relative min-h-screen bg-zinc-950 text-white font-sans selection:bg-emerald-500/30 flex flex-col">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="relative z-10 flex-grow mx-auto max-w-3xl w-full px-6 pb-24">
                    ...
                    return (
                      <div 
                        ...
                        className={`overflow-hidden rounded-2xl border transition-all duration-300 backdrop-blur-md ${
                          isOpen ? "border-emerald-500/30 bg-white/5 shadow-2xl" : "border-white/5 bg-zinc-900/60 hover:border-white/10"
                        }`}
                      >
                        <button 
          ...
          {/* SUPPORT TICKET CTA */}
          <div className="mt-20 p-8 rounded-[2rem] bg-zinc-900/80 backdrop-blur-xl border border-white/5 flex flex-col md:flex-row items-center justify-between gap-6 transition-all hover:border-emerald-500/20 shadow-2xl">
