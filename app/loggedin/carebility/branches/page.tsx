    ...
    <div className="min-h-screen bg-zinc-950 text-white font-sans selection:bg-emerald-500/30">
      ...
      <main className="flex flex-col">
            ...
            >
              ...
              <div className="relative z-10 p-12 flex flex-col h-full">
                ...
                <div className="space-y-6 mb-12">
                  {branch.details.map((detail, idx) => (
                    <div key={idx} className="flex items-center gap-4 group/item">
                      <div className={`text-zinc-500 group-hover/item:text-white transition-colors`}>{detail.icon}</div>
                      <div>
                ...
                <div className="mt-auto">
                  ...
                  >
                    <span className="text-[11px] font-black uppercase tracking-[0.2em]">View Intakes</span>
        ...
        <div className="mx-auto max-w-7xl px-6 w-full">
            <div className="mt-20 mb-24 p-12 rounded-[3rem] bg-gradient-to-r from-emerald-500/10 to-blue-500/10 border border-white/10 text-center">
