    ...
    <div className="relative min-h-screen bg-zinc-950 text-white font-sans selection:bg-emerald-500/30">
      ...
      <div className="relative z-10">
        ...
        <main className="mx-auto max-w-7xl px-6 mt-12 mb-32">
          {filteredCareers.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredCareers.map((career) => (
                <div 
                  key={career.id}
                  className="group relative p-8 rounded-[2rem] bg-zinc-900/60 backdrop-blur-md border border-white/5 hover:border-emerald-500/30 transition-all duration-500 hover:-translate-y-1 overflow-hidden"
                >
          ...
          {/* CALL TO ACTION */}
          <div className="mt-20 p-12 rounded-[3rem] bg-black/40 backdrop-blur-xl border border-white/10 text-center">
