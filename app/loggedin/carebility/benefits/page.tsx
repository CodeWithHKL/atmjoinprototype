      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="relative z-10 flex-grow mx-auto max-w-7xl w-full px-6 pb-24">
          ...
          <div className="flex flex-col items-center mb-12">
            ...
            <div className="bg-zinc-900/80 p-1.5 rounded-2xl border border-white/5 flex gap-1 backdrop-blur-xl">
          ...
          <section className="mb-20 animate-in fade-in slide-in-from-bottom-2 duration-500">
            <div className="overflow-hidden rounded-[2rem] border border-white/5 bg-zinc-900/60 backdrop-blur-md">
          ...
          <section className="grid md:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="p-8 rounded-3xl bg-zinc-900/80 backdrop-blur-md border border-white/5 transition-all hover:border-emerald-500/20">
