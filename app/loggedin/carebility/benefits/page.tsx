    ...
    <div className="min-h-screen bg-zinc-950 text-white font-sans selection:bg-emerald-500/30 flex flex-col">
      ...
      <main className="relative z-10 flex-grow mx-auto max-w-7xl w-full px-6 pb-24">
        ...
        <section className="mb-20 animate-in fade-in slide-in-from-bottom-2 duration-500">
          <div className="overflow-hidden rounded-[2rem] border border-white/5 bg-zinc-900/50 backdrop-blur-sm">
        ...
        <section className="grid md:grid-cols-4 gap-6">
          {[
            ...
            <div key={idx} className="p-8 rounded-3xl bg-zinc-900 border border-white/5 transition-all hover:border-emerald-500/20">
