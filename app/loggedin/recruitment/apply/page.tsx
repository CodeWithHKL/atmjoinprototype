...
export default function ApplicationReviewPage() {
  ...
  // Mock data for the branch being applied to (this would normally come from a URL param or state)
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white p-4 lg:p-8 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        {/* BREADCRUMB */}
        <Link href="/loggedin/recruitment" className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-zinc-500 hover:text-white transition-colors mb-8">
          <ChevronLeft size={14} /> Back to Intakes
        </Link>

        {/* HEADER */}
        <div className="mb-12">
          <h1 className="text-4xl font-black uppercase tracking-tighter">Final <span className="text-emerald-500">Review.</span></h1>
          <p className="text-zinc-500 text-sm mt-2 uppercase font-bold tracking-widest">
            Submitting for: {selectedIntake.branch} — {selectedIntake.role}
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-[2.5rem] bg-zinc-900 border border-white/5 p-8 lg:p-10">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-[11px] font-black uppercase tracking-[0.3em]">System Eligibility Cross-Check</h3>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {selectedIntake.requirements.map((req, i) => (
                <div key={i} className="flex items-center justify-between p-4 rounded-2xl bg-zinc-950 border border-white/5">
                  <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-tight">{req.label}</span>
                  {req.met ? (
            ...
            <p className="mt-6 text-[9px] font-bold text-zinc-500 uppercase leading-relaxed">
              * Based on your current <Link href="/loggedin/profile" className="text-emerald-500 underline">Personnel File</Link>. If these are incorrect, please update your profile before proceeding.
            </p>
          </section>
          ...
          <section className="rounded-[2.5rem] bg-zinc-900 border border-white/5 p-8 lg:p-10">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-[11px] font-black uppercase tracking-[0.3em]">Candidate Declaration</h3>
            </div>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex gap-4 p-4 rounded-2xl bg-white/[0.02] border border-white/5">
                  ...
                  <p className="text-[10px] font-bold text-zinc-300 uppercase leading-relaxed">{text}</p>
                </div>
              ))}
            </div>
            ...
            <label className="mt-8 flex items-center gap-4 cursor-pointer group">
              ...
              <span className="text-[11px] font-black uppercase tracking-widest text-zinc-200">I agree to the terms of service</span>
            </label>
          </section>
          ...
          <div className="p-8 rounded-[2.5rem] bg-emerald-500 text-black flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-lg font-black uppercase tracking-tighter leading-none">Confirm Submission</h4>
            ...
            <button 
              disabled={!declared}
              className={`px-10 py-5 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] flex items-center gap-3 transition-all shadow-xl ${declared ? "bg-black text-white hover:scale-105" : "bg-black/20 text-black/40 cursor-not-allowed"}`}
            >
          ...
          <div className="flex items-center justify-center gap-2 text-zinc-600">
             <Info size={14} />
             <span className="text-[9px] font-black uppercase tracking-[0.2em]">End of Application Protocol</span>
          </div>
